                ...
                <div class="card-body">
                    <form action="{{ route('products.update', $data['product']->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <select class="form-control" id="id_supplier" name="supplier_id">
                                    ...
                                    @foreach ($data['suppliers_'] as $supplier)
                                        <option value="{{ $supplier->id }}" 
                                            @if(old("supplier_id", $data['product']->supplier_id) == $supplier->id) 
                                                selected 
                        ...
                        <div class="form-group mb-3">
                            ...
                            placeholder="Masukkan Description Product">{{ old('deskripsi', $data['product']->description) }}</textarea>
